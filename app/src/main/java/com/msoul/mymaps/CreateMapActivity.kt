...
import com.msoul.mymaps.databinding.ActivityCreateMapBinding
import com.msoul.mymaps.models.Place
...
class CreateMapActivity : AppCompatActivity(), OnMapReadyCallback {
    ...
    override fun onOptionsItemSelected(item: MenuItem): Boolean {
        if (item.itemId == R.id.miSave) {
            ...
            if (markers.isEmpty()) {
                Toast.makeText(this, "There must be at lease one marker on the map", Toast.LENGTH_LONG).show()
                return true
            }
